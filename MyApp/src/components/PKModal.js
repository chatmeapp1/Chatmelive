...
export default function PKModal({ visible, onClose }) {
  ...
  // === Data user dummy ===
  const hosts = [
    { id: 1, name: "S✿DAgency✿", level: 14, avatar: "https://picsum.photos/id/1011/100" },
    { id: 2, name: "S♚Ador", level: 20, avatar: "https://picsum.photos/id/1027/100" },
    { id: 3, name: "king+boss", level: 18, avatar: "https://picsum.photos/id/1025/100" },
  ];
              ...
              <View style={styles.hostRow}>
                <View style={styles.hostInfo}>
                  ...
                  <View>
                    ...
                    <Text style={styles.hostLevel}>Lv {item.level}</Text>
                  </View>
                </View>
